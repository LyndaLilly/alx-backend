...
class Config:
    """this shows a Flask Babel configuration.
    """
    LANGUAGES = ["en", "fr"]
...
def get_user() -> Union[Dict, None]:
    """this gets a user based on a user id.
    """
...
def before_request() -> None:
    """this gets some routines before each request's resolution.
    """
    user = get_user()
    g.user = user
...
def get_timezone() -> str:
    """this gets the timezone for a web page.
    """
